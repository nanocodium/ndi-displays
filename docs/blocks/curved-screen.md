...
Cylindrical arc: radius (0.5–256 m), opening angle, height (0.5–256 m), a **distance** (0–512 m) that pushes the arc out in front of its mount, and a **height offset** (±256 m) that raises or lowers it. 360° closes it into a full video column. Concave (audience inside) or convex (audience outside), with optional video repeat around the barrel.
