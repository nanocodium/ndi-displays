...
| MCEF | Client | [Web Terminal](/blocks/web-terminal) and the Computer [Browser](/blocks/computer) app; rack [web module](/blocks/equipment-rack) | Those surfaces stay dark; the rest of the Computer OS still runs |
