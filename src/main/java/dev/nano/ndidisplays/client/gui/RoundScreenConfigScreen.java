...
import dev.nano.ndidisplays.net.UpdateRoundScreenConfigPacket;
...
/**
 * Circular screen configuration: NDI source, pixel pitch, brightness, test pattern —
 * and the disc radius, which is what makes this screen a circle of any size.
 */
public class RoundScreenConfigScreen extends Screen {
    ...
    private final RoundScreenBlockEntity screen;
    ...
    public RoundScreenConfigScreen(RoundScreenBlockEntity screen) {
        super(Component.translatable("gui.ndidisplays.round.title"));
        this.screen = screen;
    ...
    protected void init() {
        ...
        sourceBox.setMaxLength(RoundScreenBlockEntity.MAX_SOURCE_NAME);
        ...
        addRenderableWidget(new FloatSlider(left + 134, y, 130, radius,
    ...
    private void apply() {
        NetworkHandler.CHANNEL.sendToServer(new UpdateRoundScreenConfigPacket(
                screen.getBlockPos(),
